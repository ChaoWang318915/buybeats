<?php $__env->startSection('title','BuyBeats::Artists'); ?>
		...
		<div class="row row--grid">
				...
				<div class="col-12">
					<div class="main__title main__title--page">
						<h1><?php echo e($producerInfo->user_name); ?></h1>
					</div>
				</div>
				<!-- end title -->
					...
					<div class="release">
						...
						<div class="release__list">
							<ul class="main__list main__list--playlist main__list--dashbox">
								<?php $__currentLoopData = $beatsCollections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $beatsCollection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<li class="single-item">
									<a data-playlist data-title="<?php echo e($beatsCollection->beat_title); ?>" data-artist="<?php echo e($beatsCollection->user->name); ?>" data-img="<?php echo e(asset('storage/app/public/beat-image/'.$beatsCollection->beat_image)); ?>" href="<?php echo e(asset('storage/app/public/beat-file/'.$beatsCollection->beat_mp3)); ?>" class="single-item__cover">
										<img src="<?php echo e(asset('storage/app/public/beat-image/'.$beatsCollection->beat_image)); ?>" alt="">
									...
									<div class="single-item__title">
										<h4><a href="#"><?php echo e($beatsCollection->beat_title); ?></a></h4>
										<span><a href="artist.html"><?php echo e($beatsCollection->user->user_name); ?></a></span>
									</div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buybeats/public_html/resources/views/frontend/artists-collection/artist_all_beats_collection.blade.php ENDPATH**/ ?>