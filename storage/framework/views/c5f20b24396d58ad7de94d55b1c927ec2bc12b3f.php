...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/bootstrap-reboot.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/bootstrap-grid.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/owl.carousel.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/magnific-popup.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/select2.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/paymentfont.min.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/slider-radio.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/plyr.css')); ?>">
	<link rel="stylesheet" href="<?php echo e(url('public/front/css/main.css')); ?>">

	<!-- Favicons -->
	<link rel="icon" type="image/png" href="<?php echo e(url('public/front/icon/favicon-32x32.png')); ?>" sizes="32x32">
...
<body>
	...
	<!-- player include -->
	<?php echo $__env->make('frontend.layouts.player', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<!-- player include end-->
	...
	<main class="main">
		<div class="container-fluid">
			<?php echo $__env->yieldContent('frontend-body'); ?>
		</div>
	</main>
	<!-- end main content -->
	...
	<!-- JS -->
	<script src="<?php echo e(url('public/front/js/jquery-3.5.1.min.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/bootstrap.bundle.min.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/owl.carousel.min.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/jquery.magnific-popup.min.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/smooth-scrollbar.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/select2.min.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/slider-radio.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/jquery.inputmask.min.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/plyr.min.js')); ?>"></script>
	<script src="<?php echo e(url('public/front/js/main.js')); ?>"></script>
</body>
</html><?php /**PATH /home/buybeats/public_html/resources/views/frontend/layouts/master.blade.php ENDPATH**/ ?>