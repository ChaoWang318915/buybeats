...
<!-- home body content -->
			...
			<section class="row">
				<div class="col-12">
					<div class="hero owl-carousel" id="hero">
						<div class="hero__slide" data-bg="http://dmitryvolkov.me/demo/volna/img/home/slide1.jpg">
							<h1 class="hero__title">Buy Beats </h1>
						...
						<div class="hero__slide" data-bg="<?php echo e(url('public/front/img/home/buybeats-homepage-slide-sell-beats.jpg')); ?>">
							<h2 class="hero__title">Sell Beats</h2>
							<p class="hero__text"><b>Sell Your Beats </b>here at <u>BuyBeats.com</u>. We promote your beats to help you sell more beats online.</p>
							<div class="hero__btns">
						...
						<div class="hero__slide" data-bg="http://dmitryvolkov.me/demo/volna/img/home/slide3.jpg">
							<h2 class="hero__title">Beat Battle Online (Coming Soon)</h2>
							<p class="hero__text">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable</p>
							<div class="hero__btns">
								<!-- <a href="#" class="hero__btn">Learn more</a> -->
							</div>
			...
			<section class="row row--grid">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="javascript::" class="main__link">See all <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M17.92,11.62a1,1,0,0,0-.21-.33l-5-5a1,1,0,0,0-1.42,1.42L14.59,11H7a1,1,0,0,0,0,2h7.59l-3.3,3.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0l5-5a1,1,0,0,0,.21-.33A1,1,0,0,0,17.92,11.62Z"/></svg></a>
					</div>
				</div>
				<!-- end title -->
				...
				<div class="col-12">
					<div class="main__carousel-wrap">
						<div class="main__carousel main__carousel--artists owl-carousel" id="artists">
							<a href="Javascript::" class="artist">
								<div class="artist__cover">
									<img src="<?php echo e(url('public/front/img/artists/artist1.jpg')); ?>" alt="">
								</div>
							...
							<a href="Javascript::" class="artist">
								<div class="artist__cover">
									<img src="<?php echo e(url('public/front/img/artists/artist2.jpg')); ?>" alt="">
								</div>
							...
							<a href="Javascript::" class="artist">
								<div class="artist__cover">
									<img src="<?php echo e(url('public/front/img/artists/artist3.jpg')); ?>" alt="">
								</div>
							...
							<a href="Javascript::" class="artist">
								<div class="artist__cover">
									<img src="<?php echo e(url('public/front/img/artists/artist4.jpg')); ?>" alt="">
								</div>
							...
							<a href="Javascript::" class="artist">
								<div class="artist__cover">
									<img src="<?php echo e(url('public/front/img/artists/artist5.jpg')); ?>" alt="">
								</div>
							...
							<a href="Javascript::" class="artist">
								<div class="artist__cover">
									<img src="<?php echo e(url('public/front/img/artists/artist6.jpg')); ?>" alt="">
								</div>
							...
							<a href="Javascript::" class="artist">
								<div class="artist__cover">
									<img src="<?php echo e(url('public/front/img/artists/artist7.jpg')); ?>" alt="">
								</div>
							...
							<a href="Javascript::" class="artist">
								<div class="artist__cover">
									<img src="<?php echo e(url('public/front/img/artists/artist8.jpg')); ?>" alt="">
								</div>
			...
			<section class="row row--grid">
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover1.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
						...
						<div class="album__title">
							<h3><a href="Javascript::">Space Melody</a></h3>
							<span><a href="Javascript::">VIZE</a> & <a href="Javascript::">Alan Walker</a> & <a href="Javascript::">Leony</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover2.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
						...
						<div class="album__title">
							<h3><a href="Javascript::">Said Sum</a></h3>
							<span><a href="Javascript::">Moneybagg</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover3.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
						...
						<div class="album__title">
							<h3><a href="Javascript::">I Love My Country</a></h3>
							<span><a href="Javascript::">Florida Georgia</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover4.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
								<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3.71,16.29a1,1,0,0,0-.33-.21,1,1,0,0,0-.76,0,1,1,0,0,0-.33.21,1,1,0,0,0-.21.33,1,1,0,0,0,.21,1.09,1.15,1.15,0,0,0,.33.21.94.94,0,0,0,.76,0,1.15,1.15,0,0,0,.33-.21,1,1,0,0,0,.21-1.09A1,1,0,0,0,3.71,16.29ZM7,8H21a1,1,0,0,0,0-2H7A1,1,0,0,0,7,8ZM3.71,11.29a1,1,0,0,0-1.09-.21,1.15,1.15,0,0,0-.33.21,1,1,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33,1.15,1.15,0,0,0,.33.21.94.94,0,0,0,.76,0,1.15,1.15,0,0,0,.33-.21,1.15,1.15,0,0,0,.21-.33.94.94,0,0,0,0-.76A1,1,0,0,0,3.71,11.29ZM21,11H7a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2ZM3.71,6.29a1,1,0,0,0-.33-.21,1,1,0,0,0-1.09.21,1.15,1.15,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33,1.15,1.15,0,0,0,.33.21,1,1,0,0,0,1.09-.21,1.15,1.15,0,0,0,.21-.33.94.94,0,0,0,0-.76A1.15,1.15,0,0,0,3.71,6.29ZM21,16H7a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Z"/></svg> 16</span>
						...
						<div class="album__title">
							<h3><a href="Javascript::">Toosie Slide</a></h3>
							<span><a href="Javascript::">Drake</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover5.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
						...
						<div class="album__title">
							<h3><a href="Javascript::">Got What I Got</a></h3>
							<span><a href="Javascript::">Jason Aldean</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover6.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
						...
						<div class="album__title">
							<h3><a href="Javascript::">Supalonely</a></h3>
							<span><a href="Javascript::">BENEE Featuring</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover7.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
								<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3.71,16.29a1,1,0,0,0-.33-.21,1,1,0,0,0-.76,0,1,1,0,0,0-.33.21,1,1,0,0,0-.21.33,1,1,0,0,0,.21,1.09,1.15,1.15,0,0,0,.33.21.94.94,0,0,0,.76,0,1.15,1.15,0,0,0,.33-.21,1,1,0,0,0,.21-1.09A1,1,0,0,0,3.71,16.29ZM7,8H21a1,1,0,0,0,0-2H7A1,1,0,0,0,7,8ZM3.71,11.29a1,1,0,0,0-1.09-.21,1.15,1.15,0,0,0-.33.21,1,1,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33,1.15,1.15,0,0,0,.33.21.94.94,0,0,0,.76,0,1.15,1.15,0,0,0,.33-.21,1.15,1.15,0,0,0,.21-.33.94.94,0,0,0,0-.76A1,1,0,0,0,3.71,11.29ZM21,11H7a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2ZM3.71,6.29a1,1,0,0,0-.33-.21,1,1,0,0,0-1.09.21,1.15,1.15,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33,1.15,1.15,0,0,0,.33.21,1,1,0,0,0,1.09-.21,1.15,1.15,0,0,0,.21-.33.94.94,0,0,0,0-.76A1.15,1.15,0,0,0,3.71,6.29ZM21,16H7a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Z"/></svg> 16</span>
						...
						<div class="album__title">
							<h3><a href="Javascript::">Girls In The Hood</a></h3>
							<span><a href="Javascript::">Megan Thee</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover8.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
						...
						<div class="album__title">
							<h3><a href="Javascript::">Got It On Me</a></h3>
							<span><a href="Javascript::">Summer Walker</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover9.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
						...
						<div class="album__title">
							<h3><a href="Javascript::">Righteous</a></h3>
							<span><a href="Javascript::">Juice WRLD</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover10.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
								<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3.71,16.29a1,1,0,0,0-.33-.21,1,1,0,0,0-.76,0,1,1,0,0,0-.33.21,1,1,0,0,0-.21.33,1,1,0,0,0,.21,1.09,1.15,1.15,0,0,0,.33.21.94.94,0,0,0,.76,0,1.15,1.15,0,0,0,.33-.21,1,1,0,0,0,.21-1.09A1,1,0,0,0,3.71,16.29ZM7,8H21a1,1,0,0,0,0-2H7A1,1,0,0,0,7,8ZM3.71,11.29a1,1,0,0,0-1.09-.21,1.15,1.15,0,0,0-.33.21,1,1,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33,1.15,1.15,0,0,0,.33.21.94.94,0,0,0,.76,0,1.15,1.15,0,0,0,.33-.21,1.15,1.15,0,0,0,.21-.33.94.94,0,0,0,0-.76A1,1,0,0,0,3.71,11.29ZM21,11H7a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2ZM3.71,6.29a1,1,0,0,0-.33-.21,1,1,0,0,0-1.09.21,1.15,1.15,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33,1.15,1.15,0,0,0,.33.21,1,1,0,0,0,1.09-.21,1.15,1.15,0,0,0,.21-.33.94.94,0,0,0,0-.76A1.15,1.15,0,0,0,3.71,6.29ZM21,16H7a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Z"/></svg> 16</span>
						...
						<div class="album__title">
							<h3><a href="Javascript::">Walk Em Down</a></h3>
							<span><a href="Javascript::">NLE Choppa</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover11.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
						...
						<div class="album__title">
							<h3><a href="Javascript::">Like That</a></h3>
							<span><a href="Javascript::">Stefflon Don</a></span>
						</div>
					</div>
				</div>
				...
				<div class="col-6 col-sm-4 col-lg-2">
					<div class="album">
						<div class="album__cover">
							<img src="<?php echo e(url('public/front/img/covers/cover12.jpg')); ?>" alt="">
							<a href="Javascript::"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
							<span class="album__stat">
								<span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M3.71,16.29a1,1,0,0,0-.33-.21,1,1,0,0,0-.76,0,1,1,0,0,0-.33.21,1,1,0,0,0-.21.33,1,1,0,0,0,.21,1.09,1.15,1.15,0,0,0,.33.21.94.94,0,0,0,.76,0,1.15,1.15,0,0,0,.33-.21,1,1,0,0,0,.21-1.09A1,1,0,0,0,3.71,16.29ZM7,8H21a1,1,0,0,0,0-2H7A1,1,0,0,0,7,8ZM3.71,11.29a1,1,0,0,0-1.09-.21,1.15,1.15,0,0,0-.33.21,1,1,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33,1.15,1.15,0,0,0,.33.21.94.94,0,0,0,.76,0,1.15,1.15,0,0,0,.33-.21,1.15,1.15,0,0,0,.21-.33.94.94,0,0,0,0-.76A1,1,0,0,0,3.71,11.29ZM21,11H7a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2ZM3.71,6.29a1,1,0,0,0-.33-.21,1,1,0,0,0-1.09.21,1.15,1.15,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33,1.15,1.15,0,0,0,.33.21,1,1,0,0,0,1.09-.21,1.15,1.15,0,0,0,.21-.33.94.94,0,0,0,0-.76A1.15,1.15,0,0,0,3.71,6.29ZM21,16H7a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Z"/></svg> 16</span>
						...
						<div class="album__title">
							<h3><a href="Javascript::">One Big Country</a></h3>
							<span><a href="Javascript::">LOCASH</a></span>
						</div>
					</div>
				</div>
			</section>
			...
			<div class="col-12 col-md-6 col-xl-4">
					<div class="row row--grid">
						...
						<div class="col-12">
							<div class="main__title">
								<h2><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19.12,2.21A1,1,0,0,0,18.26,2l-8,2A1,1,0,0,0,9.5,5V15.35A3.45,3.45,0,0,0,8,15a3.5,3.5,0,1,0,3.5,3.5V10.78L18.74,9l.07,0L19,8.85l.15-.1a.93.93,0,0,0,.13-.15.78.78,0,0,0,.1-.15.55.55,0,0,0,.06-.18.58.58,0,0,0,0-.19.24.24,0,0,0,0-.08V3A1,1,0,0,0,19.12,2.21ZM8,20a1.5,1.5,0,1,1,1.5-1.5A1.5,1.5,0,0,1,8,20ZM17.5,7.22l-6,1.5V5.78l6-1.5Z"/></svg><a href="#">New Beats</a></h2>
							</div>
						</div>
						<!-- end title -->
							...
							<ul class="main__list">
								<li class="single-item">
									<a data-link data-title="Got What I Got" data-artist="Jason Aldean" data-img="img/covers/cover.svg')}}" href="https://dmitryvolkov.me/demo/blast2.0/audio/12071151_epic-cinematic-trailer_by_audiopizza_preview.mp3" class="single-item__cover">
										<img src="<?php echo e(url('public/front/img/covers/cover.svg')); ?>" alt="">
				...
				<div class="col-12 col-md-6 col-xl-4">
					<div class="row row--grid">
						...
						<div class="col-12">
							<div class="main__title">
								<h2><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19.12,2.21A1,1,0,0,0,18.26,2l-8,2A1,1,0,0,0,9.5,5V15.35A3.45,3.45,0,0,0,8,15a3.5,3.5,0,1,0,3.5,3.5V10.78L18.74,9l.07,0L19,8.85l.15-.1a.93.93,0,0,0,.13-.15.78.78,0,0,0,.1-.15.55.55,0,0,0,.06-.18.58.58,0,0,0,0-.19.24.24,0,0,0,0-.08V3A1,1,0,0,0,19.12,2.21ZM8,20a1.5,1.5,0,1,1,1.5-1.5A1.5,1.5,0,0,1,8,20ZM17.5,7.22l-6,1.5V5.78l6-1.5Z"/></svg><a href="#">Top Sellers</a></h2>
							</div>
						</div>
						<!-- end title -->
...
<div class="col-12 col-md-6 col-xl-4">
					<div class="row row--grid">
						...
						<div class="col-12">
							<div class="main__title">
								<h2><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19.12,2.21A1,1,0,0,0,18.26,2l-8,2A1,1,0,0,0,9.5,5V15.35A3.45,3.45,0,0,0,8,15a3.5,3.5,0,1,0,3.5,3.5V10.78L18.74,9l.07,0L19,8.85l.15-.1a.93.93,0,0,0,.13-.15.78.78,0,0,0,.1-.15.55.55,0,0,0,.06-.18.58.58,0,0,0,0-.19.24.24,0,0,0,0-.08V3A1,1,0,0,0,19.12,2.21ZM8,20a1.5,1.5,0,1,1,1.5-1.5A1.5,1.5,0,0,1,8,20ZM17.5,7.22l-6,1.5V5.78l6-1.5Z"/></svg><a href="#">Staff Picks</a></h2>
							</div>
						</div>
						<!-- end title -->
						...
						<div class="main__carousel main__carousel--podcasts owl-carousel" id="podcasts">
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/1.jpg')); ?>" alt="">
							...
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/2.jpg')); ?>" alt="">
									<span class="live__status">live</span>
							...
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/3.jpg')); ?>" alt="">
									<span class="live__status">live</span>
							...
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/4.jpg')); ?>" alt="">
									<span class="live__status">live</span>
							...
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/5.jpg')); ?>" alt="">
							...
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/6.jpg')); ?>" alt="">
									<span class="live__value">588 views</span>
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"></path></svg>
								</a>
							...
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/7.jpg')); ?>" alt="">
							...
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/8.jpg')); ?>" alt="">
							...
							<div class="live">
								<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="live__cover open-video">
									<img src="<?php echo e(url('public/front/img/live/9.jpg')); ?>" alt="">
						...
						<div class="main__carousel main__carousel--store owl-carousel" id="store">
							<div class="product">
								<div class="product__img">
									<img src="<?php echo e(url('public/front/img/store/item1.jpg')); ?>" alt="">
								...
								<h3 class="product__title"><a href="Javascript::">Vinyl Player</a></h3>
							...
							<div class="product">
								<div class="product__img">
									<img src="<?php echo e(url('public/front/img/store/item2.jpg')); ?>" alt="">

									<button class="product__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,11H13V5a1,1,0,0,0-2,0v6H5a1,1,0,0,0,0,2h6v6a1,1,0,0,0,2,0V13h6a1,1,0,0,0,0-2Z"/></svg></button>
								</div>
								<h3 class="product__title"><a href="Javascript::">Microphone R4</a></h3>
								<span class="product__price">$799</span>
							</div>

							<div class="product">
								<div class="product__img">
									<img src="<?php echo e(url('public/front/img/store/item3.jpg')); ?>" alt="">

									<button class="product__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,11H13V5a1,1,0,0,0-2,0v6H5a1,1,0,0,0,0,2h6v6a1,1,0,0,0,2,0V13h6a1,1,0,0,0,0-2Z"/></svg></button>
								</div>
								<h3 class="product__title"><a href="Javascript::">Music Blank</a></h3>
							...
							<div class="product">
								...
								<h3 class="product__title"><a href="Javascript::">Headphones ZR-991</a></h3>
								<span class="product__price">$199</span>
							</div>

							<div class="product">
								<div class="product__img">
									<img src="<?php echo e(url('public/front/img/store/item5.jpg')); ?>" alt="">

									<button class="product__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,11H13V5a1,1,0,0,0-2,0v6H5a1,1,0,0,0,0,2h6v6a1,1,0,0,0,2,0V13h6a1,1,0,0,0,0-2Z"/></svg></button>
								</div>
								<h3 class="product__title"><a href="Javascript::">Piano</a></h3>
								<span class="product__price">$11 899</span>
							</div>

							<div class="product">
								<div class="product__img">
									<img src="<?php echo e(url('public/front/img/store/item6.jpg')); ?>" alt="">
							...
							<div class="product">
								<div class="product__img">
									<img src="<?php echo e(url('public/front/img/store/item7.jpg')); ?>" alt="">

									<button class="product__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,11H13V5a1,1,0,0,0-2,0v6H5a1,1,0,0,0,0,2h6v6a1,1,0,0,0,2,0V13h6a1,1,0,0,0,0-2Z"/></svg></button>
								</div>
								<h3 class="product__title"><a href="Javascript::">Guitar</a></h3>
								<span class="product__price">$299</span>
							</div>

							<div class="product">
								<div class="product__img">
									<img src="<?php echo e(url('public/front/img/store/item8.jpg')); ?>" alt="">

									<button class="product__add" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19,11H13V5a1,1,0,0,0-2,0v6H5a1,1,0,0,0,0,2h6v6a1,1,0,0,0,2,0V13h6a1,1,0,0,0,0-2Z"/></svg></button>
								</div>
								<h3 class="product__title"><a href="Javascript::">Microphone R4s</a></h3>
								<span class="product__price">$199</span>
							</div>
						</div>
			...
			<!--	<div class="col-12 col-sm-6 col-lg-4">
					<div class="post">
						<a href="Javascript::" class="post__img">
							<img src="<?php echo e(url('public/front/img/posts/1.jpg')); ?>" alt="">
						</a>
						...
						<div class="post__content">
							...
							<h3 class="post__title"><a href="Javascript::">Foo Fighters share new live version of ‘No Son Of Mine’</a></h3>
				...
				<!--<div class="col-12 col-sm-6 col-lg-4">
					<div class="post">
						<a href="Javascript::" class="post__img">
							<img src="<?php echo e(url('public/front/img/posts/2.jpg')); ?>" alt="">
						</a>

						<div class="post__content">
							<a href="#" class="post__category">Music</a>
							<h3 class="post__title"><a href="Javascript::">Tom Grennan ‘breaks the internet’ as fans overload servers during virtual gig</a></h3>
							<div class="post__meta">
				...
				<!-- <div class="col-12 col-sm-6 col-lg-4">
					<div class="post">
						<a href="Javascript::" class="post__img">
							<img src="<?php echo e(url('public/front/img/posts/3.jpg')); ?>" alt="">
						</a>

						<div class="post__content">
							<a href="#" class="post__category">Features</a>
							<h3 class="post__title"><a href="Javascript::">Why do the Golden Globes always get it so wrong?</a></h3>
							<div class="post__meta">
				...
				<div class="col-12">
					<div class="partners owl-carousel">
						<a href="#" class="partners__img">
							<img src="<?php echo e(url('public/front/img/partners/3docean-light-background.png')); ?>" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="<?php echo e(url('public/front/img/partners/activeden-light-background.png')); ?>" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="<?php echo e(url('public/front/img/partners/audiojungle-light-background.png')); ?>" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="<?php echo e(url('public/front/img/partners/codecanyon-light-background.png')); ?>" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="<?php echo e(url('public/front/img/partners/photodune-light-background.png')); ?>" alt="">
						</a>

						<a href="#" class="partners__img">
							<img src="<?php echo e(url('public/front/img/partners/themeforest-light-background.png')); ?>" alt="">
						</a>
					</div>
				</div>
			</div>-->
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buybeats/public_html/resources/views/frontend/cover_page.blade.php ENDPATH**/ ?>