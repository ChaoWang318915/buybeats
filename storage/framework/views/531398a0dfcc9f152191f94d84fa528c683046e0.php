<!-- BEGIN: Top Bar -->
                <div class="top-bar">
                            ...
                            <div class="search-result__content">
                                ...
                                <div class="mb-5">
                                    <a href="" class="flex items-center mt-2">
                                        ...
                                        <div class="ml-3"><?php echo e(Auth::user()->name); ?></div>
                    ...
                    <div class="intro-x dropdown w-8 h-8">
                        <div class="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false">
                            ...
                            <img alt="BuyBeats" src="<?php echo e(asset('storage/app/public/'.Auth::user()->profile_photo_path)); ?>">
                            <?php else: ?>
                            <img alt="BuyBeats" src="<?php echo e(url('public/dist/images/profile-11.jpg')); ?>">
                            <?php endif; ?>
                        </div>
                        <div class="dropdown-menu w-56">
                            <div class="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                                ...
                                <div class="p-2">
                                    <a href="<?php echo e(route('profile.show')); ?>" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md"> <i data-feather="user" class="w-4 h-4 mr-2"></i> Profile </a>
                ...
                <!-- END: Top Bar --><?php /**PATH /home/buybeats/public_html/resources/views/navigation-menu.blade.php ENDPATH**/ ?>