                            ...
                            <div class="intro-y box mt-5 lg:mt-0">
                                <div class="relative flex items-center p-5">
                                    <div class="w-12 h-12 image-fit">
                                        ...
                                        <img alt="<?php echo e(asset('storage/app/public/'.$this->user->profile_photo_path)); ?>" class="rounded-full" src="<?php echo e(asset('storage/app/public/'.$this->user->profile_photo_path)); ?>" alt="">
                                        <?php else: ?>
                                        <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="<?php echo e(url('public/dist/images/profile-11.jpg')); ?>">
                                        <?php endif; ?>
                                    </div>
                                    <div class="ml-4 mr-auto">
                                        <div class="font-medium text-base"><?php echo e(Auth::user()->name); ?></div>
                        ...
                        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
                            <div class="grid grid-cols-12 gap-6">
                                ...
                                <div class="intro-y box col-span-12 2xl:col-span-6">
                                    ...
                                    <div class="p-5">
                                         <form action="<?php echo e(route('user-profile-information.update')); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mt-3"> 
                                                <label for="regular-form-1" class="form-label">First Name</label>
                                                 <input id="regular-form-1" name="first_name" type="text" class="form-control" placeholder="Input text" value="<?php echo e(Auth::user()->first_name); ?>"> 
                                             </div>
                                             
                                              <div class="mt-3"> 
                                                <label for="regular-form-1" class="form-label">Last Name</label>
                                                 <input id="regular-form-1" name="last_name" type="text" class="form-control" placeholder="Input text" value="<?php echo e(Auth::user()->last_name); ?>"> 
                                             </div>

                                             <div class="mt-3"> 
                                                <label for="regular-form-1" class="form-label">Email</label>
                                                 <input id="regular-form-1" name="email" type="text" class="form-control" placeholder="Input text" value="<?php echo e(Auth::user()->email); ?>"> 
                                             </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/buybeats/public_html/resources/views/profile/update-profile-information-form.blade.php ENDPATH**/ ?>