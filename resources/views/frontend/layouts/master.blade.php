...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="{{url('public/front/css/bootstrap-reboot.min.css')}}">
	<link rel="stylesheet" href="{{url('public/front/css/bootstrap-grid.min.css')}}">
	...
	<link rel="stylesheet" href="{{url('public/front/css/select2.min.css')}}">
	<link rel="stylesheet" href="{{url('public/front/css/paymentfont.min.css')}}">
	<link rel="stylesheet" href="{{url('public/front/css/slider-radio.css')}}">
	<link rel="stylesheet" href="{{url('public/front/css/plyr.css')}}">
	<link rel="stylesheet" href="{{url('public/front/css/main.css')}}">

	<!-- Favicons -->
	<link rel="icon" type="image/png" href="{{url('public/front/icon/favicon-32x32.png')}}" sizes="32x32">
...
<body>
	...
	<script src="{{url('public/front/js/slider-radio.js')}}"></script>
	<script src="{{url('public/front/js/jquery.inputmask.min.js')}}"></script>
	<script src="{{url('public/front/js/plyr.min.js')}}"></script>
