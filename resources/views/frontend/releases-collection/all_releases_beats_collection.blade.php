...
@section('title','BuyBeats::Release')
				...
				<div class="col-12">
					...
					<div class="row row--grid main__list--playlist main__list--dashbox">
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
							    {{--
								<div class="album__cover" style="display:none">
									<img src="{{ asset('storage/app/public/beat-image/'.$collection->beat_image) }}" alt="{{$collection->beat_title}}">
									<a href="{{route('collection_of_artist_beats',str_replace(' ', '',$collection->user->user_name))}}"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/></svg></a>
								...
								<div class="album__cover">
									...
									<span class="single-item">
										<a data-playlist data-title="{{$collection->beat_title}}" data-artist="{{str_replace(' ', '',$collection->user->user_name)}}" data-img="{{ asset('storage/app/public/beat-image/'.$collection->beat_image) }}" href="{{ asset('storage/app/public/beat-file/'.$collection->beat_mp3) }}" class="single-item__cover">
								...
								<div class="album__title">
									<h3><a href="{{route('collection_of_artist_beats',str_replace(' ', '',$collection->user->user_name))}}">{{$collection->beat_title}}</a></h3>
									<span><a href="{{route('collection_of_artist_beats',str_replace(' ', '',$collection->user->user_name))}}">{{$collection->user->user_name}}</a></span>
								</div>
							</div>
						</div>
						@endforeach
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">Moneybagg</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">Florida Georgia</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">Drake</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">Jason Aldean</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">BENEE Featuring</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">Megan Thee</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">Summer Walker</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">Juice WRLD</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">NLE Choppa</a></span>
								</div>
							</div>
						</div>
						...
						<div class="col-6 col-sm-4 col-lg-2">
							<div class="album">
								...
								<div class="album__title">
									...
									<span><a href="{{route('collection_of_artist_beats')}}">Stefflon Don</a></span>
								</div>
							</div>
						</div>
